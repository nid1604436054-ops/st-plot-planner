...
// （2026-08-29 真机第六轮改定轮换制：整张清单洗牌成一条队按序发，全部条目各发一次之前
...
// 冷却期内抓取自动跳过、按采用次数计（2026-08-29 真机第五轮改定：结算在「确认采用/转隐身
 ...
 * feed = 投喂方式（2026-08-29 真机第七轮）：'sample' 抽样（默认，轮换抓一小把让模型挑）|
 ...
 * 2026-08-29 真机第六轮：纯随机改轮换制）。每张清单一条轮换队列 list.queue＝本轮剩余
...
/**
 * 用后账结算（2026-08-29 真机第五轮改定：只在规划真正上场时执行——「确认采用」或「转为
...
// 手动清零一条条目的冷却（知识库页点冷却徽章，2026-08-29 真机第五轮：冷却此前没有任何
